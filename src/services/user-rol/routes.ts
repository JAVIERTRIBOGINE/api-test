...
export default [
    {
        ...
        handler: [
            ...
            async (req: Request, res: Response) => {
                ...
                try {
                        result = await UserRolController.listAll();
    ...
    },
    {
        ...
        handler: [
            ...
            async (req: Request, res: Response) => {
                ...
                // // infoLog(logMessages.SEVERITY.INFO,  req, res, null, null, details );
                try {
                    const result = await UserRolController.findOne(req.params.id);
                    // details = details.replace(logMessages.PROCESS.INIT, logMessages.PROCESS.END);
                    // infoLog(logMessages.SEVERITY.INFO,  req, res, result, 200, details );
                    res.status(200).send(result);
                } catch (e) {
            ...
            async (req: Request, res: Response) => {
                ...
                try {
                    if (req.body.name != undefined && req.body.country_oid != undefined) {
                        const result = await UserRolController.insert(req.body, res.locals.jwtPayload.userId);
                        // details = details.replace(logMessages.PROCESS.INIT, logMessages.PROCESS.END);
                        // infoLog(logMessages.SEVERITY.INFO,  req, res, result, 200, details );
                        // (req.ip,
    ...
    },
    {
        ...
        handler: [
            ...
            async (req: Request, res: Response) => {
                ...
                try {
                    if (req.body.name !== undefined && req.body.country_oid !== undefined) {
                        const result = await UserRolController.update(req.params.oid, req.body, res.locals.jwtPayload.userId);
                        // (req.ip,
    ...
    },
    {
        ...
        handler: [
            ...
            async (req: Request, res: Response) => {
                ...
                // // infoLog(logMessages.SEVERITY.INFO,  req, res, null, null, details );
                try {
                    const zoneDeleted = await UserRolController.delete(req.params.oid);
                    // details = details.replace(logMessages.PROCESS.INIT, logMessages.PROCESS.END);
